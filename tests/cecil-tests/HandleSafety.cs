...
namespace Cecil.Tests {
	...
	public partial class HandleSafetyTest {
		...
		// Returns true if the object represented by 'value' is passed to GC.KeepAlive somewhere in the method.
		// This handles the following (safe) code pattern:
		//     var obj = ...;
		...
		bool IsKeptAlive (MethodState state, Instruction value)
		{
			foreach (var instr in state.Method.Body.Instructions) {
