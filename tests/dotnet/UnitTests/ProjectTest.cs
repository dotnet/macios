...
namespace Xamarin.Tests {
	...
	public class DotNetProjectTest : TestBaseClass {
		...
		internal static void PluralRuntimeIdentifiersImpl (ApplePlatform platform, string runtimeIdentifiers, bool? useMonoRuntime = null, Dictionary<string, string>? extraProperties = null)
		{
			var project = "MySimpleApp";
			Configuration.IgnoreIfIgnoredPlatform (platform);
			Configuration.AssertRuntimeIdentifiersAvailable (platform, runtimeIdentifiers);
			...
			if (useMonoRuntime.HasValue)
				properties ["UseMonoRuntime"] = useMonoRuntime.Value ? "true" : "false";
