...
- `{Platform}-{Variant}-size.txt.diff` — e.g., `iOS-CoreCLR-Interpreter-size.txt.diff`, `iOS-CoreCLR-R2R-size.txt.diff`, `iOS-NativeAOT-size.txt.diff`, `MacOSX-NativeAOT-TrimmableStatic-size.txt.diff`
