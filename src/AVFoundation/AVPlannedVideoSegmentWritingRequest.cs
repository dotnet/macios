...
namespace AVFoundation {
	public partial class AVPlannedVideoSegmentWritingRequest {
		...
		/// <param name="encoderSpecification">A dictionary describing the characteristics of a video encoder to use, or <see langword="null" /> to let the system choose an encoder.</param>
		...
		public VTCompressionSession? CreateResumableCompressionSession (int width, int height, CMVideoCodecType codecType, VTCompressionSession.VTCompressionOutputCallback? compressionOutputCallback, NSDictionary? encoderSpecification = null, NSDictionary? sourceImageBufferAttributes = null)
		...
		[SupportedOSPlatform ("macos27.0")]
		[SupportedOSPlatform ("maccatalyst27.0")]
		public VTCompressionSession? CreateResumableCompressionSession (int width, int height, CMVideoCodecType codecType, VTCompressionSession.VTCompressionOutputCallback? compressionOutputCallback, NSDictionary? encoderSpecification, NSDictionary? sourceImageBufferAttributes, out NSError? error)
		{
