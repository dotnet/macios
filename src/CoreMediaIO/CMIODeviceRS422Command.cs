...
namespace CoreMediaIO {
	...
	/// <summary>Represents an RS422 command to be sent to a CoreMediaIO device.</summary>
...
#if !COREBUILD
		/// <summary>Gets or sets a pointer to the buffer containing the RS422 command bytes.</summary>
