...
#pragma warning restore CS0618
		...
		{
			BuildImpl (platform, runtimeIdentifiers, signature, configuration);
		}

		void BuildImpl (ApplePlatform platform, string runtimeIdentifiers, CodeSignature signature, string configuration)
		{
