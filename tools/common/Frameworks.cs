...
public class Frameworks : Dictionary<string, Framework> {
	...
	public static Frameworks CreateiOSFrameworks (bool is_simulator_build)
	{
		return new Frameworks () {
				...
				{ "ARKit", "ARKit", 11 },
				{ "CoreNFC", "CoreNFC", new Version (11, 0), new Version (17, 0), true }, /* not always present, e.g. iPad w/iOS 12, so must be weak linked; doesn't work in the simulator in Xcode 12 (https://stackoverflow.com/q/63915728/183422), but works in at least Xcode 17 (maybe earlier too) */
