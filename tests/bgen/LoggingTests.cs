...
namespace GeneratorTests {
	...
	public class LoggingTests {
		...
		public void InjectedLog ()
		{
			...
			var exitCode = BindingTouch.Run (new [] { "--use-zero-copy", "--help" }, log, CancellationToken.None, null);
		...
		public void InjectedLogError ()
		{
			...
			var exitCode = BindingTouch.Run (new [] { "api.cs" }, log, CancellationToken.None, null);
		...
		public void Cancellation ()
		{
			...
			Assert.Throws<OperationCanceledException> (() => BindingTouch.Run ([], new TestLog (), cancellationToken, null));
		}
