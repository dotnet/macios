	...
	class TestDataGetSelectorHandleField : IEnumerable<object []> {
		public IEnumerator<object []> GetEnumerator ()
		{
			...
			yield return [
				"RTFDFileWrapperFromRange:documentAttributes:",
				"selRTFDFileWrapperFromRange_DocumentAttributes_XHandle",
				"static readonly global::ObjCRuntime.NativeHandle selRTFDFileWrapperFromRange_DocumentAttributes_XHandle = Selector.GetHandle (\"RTFDFileWrapperFromRange:documentAttributes:\");"
			];

			yield return [
				"RTFDFromRange:documentAttributes:",
				"selRTFDFromRange_DocumentAttributes_XHandle",
				"static readonly global::ObjCRuntime.NativeHandle selRTFDFromRange_DocumentAttributes_XHandle = Selector.GetHandle (\"RTFDFromRange:documentAttributes:\");"
			];
