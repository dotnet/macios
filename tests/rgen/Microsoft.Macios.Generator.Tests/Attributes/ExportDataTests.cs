	...
	class TestDataToString : IEnumerable<object []> {
		public IEnumerator<object []> GetEnumerator ()
		{
			yield return [
				...
				"{ Type: 'ObjCBindings.Method', Selector: 'symbol', ArgumentSemantic: 'None', Flags: 'Default', NativePrefix: 'null', NativeSuffix: 'null', Library: 'null', ResultType: 'null', MethodName: 'null', ResultTypeName: 'null', PostNonResultSnippet: 'null', StrongDelegateType: 'null' }",
			];
			yield return [
				Method.Default,
			...
			yield return [
				...
				"{ Type: 'ObjCBindings.Property', Selector: 'symbol', ArgumentSemantic: 'Retain', Flags: 'Default', NativePrefix: 'null', NativeSuffix: 'null', Library: 'null', ResultType: 'null', MethodName: 'null', ResultTypeName: 'null', PostNonResultSnippet: 'null', StrongDelegateType: 'null' }"
			];
			yield return [
				Property.Default,
				new ExportData<Property> ("symbol"),
				"{ Type: 'ObjCBindings.Property', Selector: 'symbol', ArgumentSemantic: 'None', Flags: 'Default', NativePrefix: 'null', NativeSuffix: 'null', Library: 'null', ResultType: 'null', MethodName: 'null', ResultTypeName: 'null', PostNonResultSnippet: 'null', StrongDelegateType: 'null' }"
			];
			yield return [
				Method.Default,
				...
				"{ Type: 'ObjCBindings.Method', Selector: 'symbol', ArgumentSemantic: 'None', Flags: 'CustomMarshalDirective', NativePrefix: 'xamarin_', NativeSuffix: 'null', Library: '__Internal', ResultType: 'null', MethodName: 'null', ResultTypeName: 'null', PostNonResultSnippet: 'null', StrongDelegateType: 'null' }"
			];
		}
