...
namespace CoreMedia {
	...
	public class CMFormatDescription : NativeObject {
		...
		/// <remarks>Only applicable if this format descripton's <see cref="MediaType" /> is <see cref="CMMediaType.Video" />, otherwise 0 is returned. If <see cref="MediaSubType" /> property isn't a pixel format, use <see cref="VideoSubType" /> instead.</remarks>
