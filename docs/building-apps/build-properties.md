...
environment variable is set to `1` at startup, which makes the .NET runtime
write a crash report when the app crashes.
...
Only applicable when using the CoreCLR runtime.
