...
namespace SecurityInterface {
	...
	interface SFCertificateView {
		...
		/// <summary>Sets the certificate to display.</summary>
		/// <param name="certificate">The <see cref="SecCertificate" /> to display, or <see langword="null" /> to clear.</param>
		[Export ("setCertificate:")]
		void SetCertificate ([NullAllowed] SecCertificate certificate);

		/// <summary>Gets the currently displayed certificate.</summary>
		/// <returns>The <see cref="SecCertificate" /> being displayed, or <see langword="null" />.</returns>
		[Export ("certificate")]
		[return: NullAllowed]
	...
	interface SFKeychainSavePanel {
		...
		/// <summary>Gets the keychain that was created, or <see langword="null" /> if the user cancelled.</summary>
		[Export ("keychain")]
		[NullAllowed]
	...
	interface SFKeychainSettingsPanel {
		...
		/// <param name="settings">The <see cref="SecKeychainSettings" /> to edit.</param>
		/// <param name="keychain">The <see cref="SecKeychain" /> whose settings to edit.</param>
		/// <returns>The button code that was pressed to dismiss the panel.</returns>
		[Export ("runModalForSettings:keychain:")]
		nint RunModalForSettings (ref SecKeychainSettings settings, SecKeychain keychain);

		/// <summary>Displays the panel as a sheet for editing the specified keychain settings.</summary>
		/// <param name="docWindow">The window to which the sheet is attached.</param>
		/// <param name="modalDelegate">The delegate that receives the did-end callback, or <see langword="null" />.</param>
		/// <param name="didEndSelector">The selector invoked when the sheet ends, or <see langword="null" />.</param>
		/// <param name="contextInfo">A pointer to context information passed to the callback.</param>
